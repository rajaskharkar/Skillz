...
data class OngoingSessionEntity(
    ...
    val anchorEnabledForFlow: Boolean = false,
    val anchorDisabledForFlow: Boolean = false,
    val anchorPaused: Boolean = false,
    val anchorBreakStartedAtMs: Long? = null,
    val anchorBreakEndsAtMs: Long? = null,

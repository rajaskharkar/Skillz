...
object ShellContentCatalog {
    ...
    val finds = listOf(
        ...
        ShellFindDefinition(FOCUS_OCTOPUS, R.string.shell_find_octopus_title, R.string.shell_find_octopus_description, ShellFindCategory.CREATURES, ShellRoomId.FOCUS, "octopus", "octopus", true, true, false, setOf(ShellSlotType.CREATURE_PERCH, ShellSlotType.MEMORY_NOOK), kind = ShellRewardKind.ANIMAL, depthTier = ShellDepthTier.DEEPER_REEF),
        ShellFindDefinition("creature_clownfish", R.string.shell_find_clownfish_title, R.string.shell_find_clownfish_description, ShellFindCategory.CREATURES, ShellRoomId.FOCUS, "creature_icon_creature_clownfish", "creature_clownfish", true, true, false, setOf(ShellSlotType.CREATURE_PERCH, ShellSlotType.TIDEPOOL_EDGE, ShellSlotType.CURRENT_PATH, ShellSlotType.CENTERPIECE), kind = ShellRewardKind.ANIMAL, depthTier = ShellDepthTier.REEF),
        ShellFindDefinition("creature_blue_tang", R.string.shell_find_blue_tang_title, R.string.shell_find_blue_tang_description, ShellFindCategory.CREATURES, ShellRoomId.FOCUS, "creature_icon_creature_blue_tang", "creature_blue_tang", true, true, false, setOf(ShellSlotType.CREATURE_PERCH, ShellSlotType.TIDEPOOL_EDGE, ShellSlotType.CURRENT_PATH, ShellSlotType.CENTERPIECE), kind = ShellRewardKind.ANIMAL, depthTier = ShellDepthTier.REEF),
        ShellFindDefinition("creature_butterflyfish", R.string.shell_find_butterflyfish_title, R.string.shell_find_butterflyfish_description, ShellFindCategory.CREATURES, ShellRoomId.FOCUS, "creature_icon_creature_butterflyfish", "creature_butterflyfish", true, true, false, setOf(ShellSlotType.CREATURE_PERCH, ShellSlotType.TIDEPOOL_EDGE, ShellSlotType.CURRENT_PATH, ShellSlotType.CENTERPIECE), kind = ShellRewardKind.ANIMAL, depthTier = ShellDepthTier.REEF),
        ShellFindDefinition("creature_angelfish", R.string.shell_find_angelfish_title, R.string.shell_find_angelfish_description, ShellFindCategory.CREATURES, ShellRoomId.FOCUS, "creature_icon_creature_angelfish", "creature_angelfish", true, true, false, setOf(ShellSlotType.CREATURE_PERCH, ShellSlotType.TIDEPOOL_EDGE, ShellSlotType.CURRENT_PATH, ShellSlotType.CENTERPIECE), kind = ShellRewardKind.ANIMAL, depthTier = ShellDepthTier.REEF),
        ShellFindDefinition("creature_parrotfish", R.string.shell_find_parrotfish_title, R.string.shell_find_parrotfish_description, ShellFindCategory.CREATURES, ShellRoomId.FOCUS, "creature_icon_creature_parrotfish", "creature_parrotfish", true, true, false, setOf(ShellSlotType.CREATURE_PERCH, ShellSlotType.TIDEPOOL_EDGE, ShellSlotType.CURRENT_PATH, ShellSlotType.CENTERPIECE), kind = ShellRewardKind.ANIMAL, depthTier = ShellDepthTier.REEF),
        ShellFindDefinition("creature_jellyfish", R.string.shell_find_jellyfish_title, R.string.shell_find_jellyfish_description, ShellFindCategory.CREATURES, ShellRoomId.FOCUS, "creature_icon_creature_jellyfish", "creature_jellyfish", true, true, false, setOf(ShellSlotType.CREATURE_PERCH, ShellSlotType.TIDEPOOL_EDGE, ShellSlotType.CURRENT_PATH, ShellSlotType.CENTERPIECE), kind = ShellRewardKind.ANIMAL, depthTier = ShellDepthTier.REEF),
        ShellFindDefinition("creature_sea_turtle", R.string.shell_find_sea_turtle_title, R.string.shell_find_sea_turtle_description, ShellFindCategory.CREATURES, ShellRoomId.FOCUS, "creature_icon_creature_sea_turtle", "creature_sea_turtle", true, true, false, setOf(ShellSlotType.CREATURE_PERCH, ShellSlotType.TIDEPOOL_EDGE, ShellSlotType.CURRENT_PATH, ShellSlotType.CENTERPIECE), kind = ShellRewardKind.ANIMAL, depthTier = ShellDepthTier.REEF),
        ShellFindDefinition("creature_sea_otter", R.string.shell_find_sea_otter_title, R.string.shell_find_sea_otter_description, ShellFindCategory.CREATURES, ShellRoomId.FOCUS, "creature_icon_creature_sea_otter", "creature_sea_otter", true, true, false, setOf(ShellSlotType.CREATURE_PERCH, ShellSlotType.TIDEPOOL_EDGE, ShellSlotType.CURRENT_PATH, ShellSlotType.CENTERPIECE), kind = ShellRewardKind.ANIMAL, depthTier = ShellDepthTier.REEF),
        ShellFindDefinition("creature_seal", R.string.shell_find_seal_title, R.string.shell_find_seal_description, ShellFindCategory.CREATURES, ShellRoomId.FOCUS, "creature_icon_creature_seal", "creature_seal", true, true, false, setOf(ShellSlotType.CREATURE_PERCH, ShellSlotType.TIDEPOOL_EDGE, ShellSlotType.CURRENT_PATH, ShellSlotType.CENTERPIECE), kind = ShellRewardKind.ANIMAL, depthTier = ShellDepthTier.REEF),
        ShellFindDefinition("creature_starfish", R.string.shell_find_starfish_title, R.string.shell_find_starfish_description, ShellFindCategory.CREATURES, ShellRoomId.FOCUS, "creature_icon_creature_starfish", "creature_starfish", true, true, false, setOf(ShellSlotType.CREATURE_PERCH, ShellSlotType.TIDEPOOL_EDGE, ShellSlotType.CURRENT_PATH, ShellSlotType.CENTERPIECE), kind = ShellRewardKind.ANIMAL, depthTier = ShellDepthTier.DEEPER_REEF),
        ShellFindDefinition("creature_sea_urchin", R.string.shell_find_sea_urchin_title, R.string.shell_find_sea_urchin_description, ShellFindCategory.CREATURES, ShellRoomId.FOCUS, "creature_icon_creature_sea_urchin", "creature_sea_urchin", true, true, false, setOf(ShellSlotType.CREATURE_PERCH, ShellSlotType.TIDEPOOL_EDGE, ShellSlotType.CURRENT_PATH, ShellSlotType.CENTERPIECE), kind = ShellRewardKind.ANIMAL, depthTier = ShellDepthTier.DEEPER_REEF),
        ShellFindDefinition("creature_pufferfish", R.string.shell_find_pufferfish_title, R.string.shell_find_pufferfish_description, ShellFindCategory.CREATURES, ShellRoomId.FOCUS, "creature_icon_creature_pufferfish", "creature_pufferfish", true, true, false, setOf(ShellSlotType.CREATURE_PERCH, ShellSlotType.TIDEPOOL_EDGE, ShellSlotType.CURRENT_PATH, ShellSlotType.CENTERPIECE), kind = ShellRewardKind.ANIMAL, depthTier = ShellDepthTier.DEEPER_REEF),
        ShellFindDefinition("creature_lionfish", R.string.shell_find_lionfish_title, R.string.shell_find_lionfish_description, ShellFindCategory.CREATURES, ShellRoomId.FOCUS, "creature_icon_creature_lionfish", "creature_lionfish", true, true, false, setOf(ShellSlotType.CREATURE_PERCH, ShellSlotType.TIDEPOOL_EDGE, ShellSlotType.CURRENT_PATH, ShellSlotType.CENTERPIECE), kind = ShellRewardKind.ANIMAL, depthTier = ShellDepthTier.DEEPER_REEF),
        ShellFindDefinition("creature_moray_eel", R.string.shell_find_moray_eel_title, R.string.shell_find_moray_eel_description, ShellFindCategory.CREATURES, ShellRoomId.FOCUS, "creature_icon_creature_moray_eel", "creature_moray_eel", true, true, false, setOf(ShellSlotType.CREATURE_PERCH, ShellSlotType.TIDEPOOL_EDGE, ShellSlotType.CURRENT_PATH, ShellSlotType.CENTERPIECE), kind = ShellRewardKind.ANIMAL, depthTier = ShellDepthTier.DEEPER_REEF),
        ShellFindDefinition("creature_stingray", R.string.shell_find_stingray_title, R.string.shell_find_stingray_description, ShellFindCategory.CREATURES, ShellRoomId.FOCUS, "creature_icon_creature_stingray", "creature_stingray", true, true, false, setOf(ShellSlotType.CREATURE_PERCH, ShellSlotType.TIDEPOOL_EDGE, ShellSlotType.CURRENT_PATH, ShellSlotType.CENTERPIECE), kind = ShellRewardKind.ANIMAL, depthTier = ShellDepthTier.DEEPER_REEF),
        ShellFindDefinition("creature_sea_snake", R.string.shell_find_sea_snake_title, R.string.shell_find_sea_snake_description, ShellFindCategory.CREATURES, ShellRoomId.FOCUS, "creature_icon_creature_sea_snake", "creature_sea_snake", true, true, false, setOf(ShellSlotType.CREATURE_PERCH, ShellSlotType.TIDEPOOL_EDGE, ShellSlotType.CURRENT_PATH, ShellSlotType.CENTERPIECE), kind = ShellRewardKind.ANIMAL, depthTier = ShellDepthTier.DEEPER_REEF),
        ShellFindDefinition("creature_squid", R.string.shell_find_squid_title, R.string.shell_find_squid_description, ShellFindCategory.CREATURES, ShellRoomId.FOCUS, "creature_icon_creature_squid", "creature_squid", true, true, false, setOf(ShellSlotType.CREATURE_PERCH, ShellSlotType.TIDEPOOL_EDGE, ShellSlotType.CURRENT_PATH, ShellSlotType.CENTERPIECE), kind = ShellRewardKind.ANIMAL, depthTier = ShellDepthTier.DEEPER_REEF),
        ShellFindDefinition("creature_flying_fish", R.string.shell_find_flying_fish_title, R.string.shell_find_flying_fish_description, ShellFindCategory.CREATURES, ShellRoomId.FOCUS, "creature_icon_creature_flying_fish", "creature_flying_fish", true, true, false, setOf(ShellSlotType.CREATURE_PERCH, ShellSlotType.TIDEPOOL_EDGE, ShellSlotType.CURRENT_PATH, ShellSlotType.CENTERPIECE), kind = ShellRewardKind.ANIMAL, depthTier = ShellDepthTier.OPEN_BLUE),
        ShellFindDefinition("creature_barracuda", R.string.shell_find_barracuda_title, R.string.shell_find_barracuda_description, ShellFindCategory.CREATURES, ShellRoomId.FOCUS, "creature_icon_creature_barracuda", "creature_barracuda", true, true, false, setOf(ShellSlotType.CREATURE_PERCH, ShellSlotType.TIDEPOOL_EDGE, ShellSlotType.CURRENT_PATH, ShellSlotType.CENTERPIECE), kind = ShellRewardKind.ANIMAL, depthTier = ShellDepthTier.OPEN_BLUE),
        ShellFindDefinition("creature_swordfish", R.string.shell_find_swordfish_title, R.string.shell_find_swordfish_description, ShellFindCategory.CREATURES, ShellRoomId.FOCUS, "creature_icon_creature_swordfish", "creature_swordfish", true, true, false, setOf(ShellSlotType.CREATURE_PERCH, ShellSlotType.TIDEPOOL_EDGE, ShellSlotType.CURRENT_PATH, ShellSlotType.CENTERPIECE), kind = ShellRewardKind.ANIMAL, depthTier = ShellDepthTier.OPEN_BLUE),
        ShellFindDefinition("creature_dolphin", R.string.shell_find_dolphin_title, R.string.shell_find_dolphin_description, ShellFindCategory.CREATURES, ShellRoomId.FOCUS, "creature_icon_creature_dolphin", "creature_dolphin", true, true, false, setOf(ShellSlotType.CREATURE_PERCH, ShellSlotType.TIDEPOOL_EDGE, ShellSlotType.CURRENT_PATH, ShellSlotType.CENTERPIECE), kind = ShellRewardKind.ANIMAL, depthTier = ShellDepthTier.OPEN_BLUE),
        ShellFindDefinition("creature_ocean_sunfish", R.string.shell_find_ocean_sunfish_title, R.string.shell_find_ocean_sunfish_description, ShellFindCategory.CREATURES, ShellRoomId.FOCUS, "creature_icon_creature_ocean_sunfish", "creature_ocean_sunfish", true, true, false, setOf(ShellSlotType.CREATURE_PERCH, ShellSlotType.TIDEPOOL_EDGE, ShellSlotType.CURRENT_PATH, ShellSlotType.CENTERPIECE), kind = ShellRewardKind.ANIMAL, depthTier = ShellDepthTier.OPEN_BLUE),
        ShellFindDefinition("creature_penguin", R.string.shell_find_penguin_title, R.string.shell_find_penguin_description, ShellFindCategory.CREATURES, ShellRoomId.FOCUS, "creature_icon_creature_penguin", "creature_penguin", true, true, false, setOf(ShellSlotType.CREATURE_PERCH, ShellSlotType.TIDEPOOL_EDGE, ShellSlotType.CURRENT_PATH, ShellSlotType.CENTERPIECE), kind = ShellRewardKind.ANIMAL, depthTier = ShellDepthTier.OPEN_BLUE),
        ShellFindDefinition("creature_sea_lion", R.string.shell_find_sea_lion_title, R.string.shell_find_sea_lion_description, ShellFindCategory.CREATURES, ShellRoomId.FOCUS, "creature_icon_creature_sea_lion", "creature_sea_lion", true, true, false, setOf(ShellSlotType.CREATURE_PERCH, ShellSlotType.TIDEPOOL_EDGE, ShellSlotType.CURRENT_PATH, ShellSlotType.CENTERPIECE), kind = ShellRewardKind.ANIMAL, depthTier = ShellDepthTier.OPEN_BLUE),
        ShellFindDefinition("creature_orca", R.string.shell_find_orca_title, R.string.shell_find_orca_description, ShellFindCategory.CREATURES, ShellRoomId.FOCUS, "creature_icon_creature_orca", "creature_orca", true, true, false, setOf(ShellSlotType.CREATURE_PERCH, ShellSlotType.TIDEPOOL_EDGE, ShellSlotType.CURRENT_PATH, ShellSlotType.CENTERPIECE), kind = ShellRewardKind.ANIMAL, depthTier = ShellDepthTier.OPEN_BLUE),
        ShellFindDefinition("creature_great_white_shark", R.string.shell_find_great_white_shark_title, R.string.shell_find_great_white_shark_description, ShellFindCategory.CREATURES, ShellRoomId.FOCUS, "creature_icon_creature_great_white_shark", "creature_great_white_shark", true, true, false, setOf(ShellSlotType.CREATURE_PERCH, ShellSlotType.TIDEPOOL_EDGE, ShellSlotType.CURRENT_PATH, ShellSlotType.CENTERPIECE), kind = ShellRewardKind.ANIMAL, depthTier = ShellDepthTier.OPEN_BLUE),
        ShellFindDefinition("creature_anglerfish", R.string.shell_find_anglerfish_title, R.string.shell_find_anglerfish_description, ShellFindCategory.CREATURES, ShellRoomId.FOCUS, "creature_icon_creature_anglerfish", "creature_anglerfish", true, true, false, setOf(ShellSlotType.CREATURE_PERCH, ShellSlotType.TIDEPOOL_EDGE, ShellSlotType.CURRENT_PATH, ShellSlotType.CENTERPIECE), kind = ShellRewardKind.ANIMAL, depthTier = ShellDepthTier.DEEP_OCEAN),
        ShellFindDefinition("creature_leatherback_turtle", R.string.shell_find_leatherback_turtle_title, R.string.shell_find_leatherback_turtle_description, ShellFindCategory.CREATURES, ShellRoomId.FOCUS, "creature_icon_creature_leatherback_turtle", "creature_leatherback_turtle", true, true, false, setOf(ShellSlotType.CREATURE_PERCH, ShellSlotType.TIDEPOOL_EDGE, ShellSlotType.CURRENT_PATH, ShellSlotType.CENTERPIECE), kind = ShellRewardKind.ANIMAL, depthTier = ShellDepthTier.DEEP_OCEAN),
        ShellFindDefinition("creature_giant_squid", R.string.shell_find_giant_squid_title, R.string.shell_find_giant_squid_description, ShellFindCategory.CREATURES, ShellRoomId.FOCUS, "creature_icon_creature_giant_squid", "creature_giant_squid", true, true, false, setOf(ShellSlotType.CREATURE_PERCH, ShellSlotType.TIDEPOOL_EDGE, ShellSlotType.CURRENT_PATH, ShellSlotType.CENTERPIECE), kind = ShellRewardKind.ANIMAL, depthTier = ShellDepthTier.DEEP_OCEAN),
        ShellFindDefinition("creature_humpback_whale", R.string.shell_find_humpback_whale_title, R.string.shell_find_humpback_whale_description, ShellFindCategory.CREATURES, ShellRoomId.FOCUS, "creature_icon_creature_humpback_whale", "creature_humpback_whale", true, true, false, setOf(ShellSlotType.CREATURE_PERCH, ShellSlotType.TIDEPOOL_EDGE, ShellSlotType.CURRENT_PATH, ShellSlotType.CENTERPIECE), kind = ShellRewardKind.ANIMAL, depthTier = ShellDepthTier.DEEP_OCEAN),
        ShellFindDefinition("creature_blue_whale", R.string.shell_find_blue_whale_title, R.string.shell_find_blue_whale_description, ShellFindCategory.CREATURES, ShellRoomId.FOCUS, "creature_icon_creature_blue_whale", "creature_blue_whale", true, true, false, setOf(ShellSlotType.CREATURE_PERCH, ShellSlotType.TIDEPOOL_EDGE, ShellSlotType.CURRENT_PATH, ShellSlotType.CENTERPIECE), kind = ShellRewardKind.ANIMAL, depthTier = ShellDepthTier.DEEP_OCEAN),
        ShellFindDefinition("creature_megalodon", R.string.shell_find_megalodon_title, R.string.shell_find_megalodon_description, ShellFindCategory.CREATURES, ShellRoomId.FOCUS, "creature_icon_creature_megalodon", "creature_megalodon", true, true, false, setOf(ShellSlotType.CREATURE_PERCH, ShellSlotType.TIDEPOOL_EDGE, ShellSlotType.CURRENT_PATH, ShellSlotType.CENTERPIECE), kind = ShellRewardKind.ANIMAL, depthTier = ShellDepthTier.DEEP_OCEAN),
        ShellFindDefinition("creature_kraken", R.string.shell_find_kraken_title, R.string.shell_find_kraken_description, ShellFindCategory.CREATURES, ShellRoomId.FOCUS, "creature_icon_creature_kraken", "creature_kraken", true, true, false, setOf(ShellSlotType.CREATURE_PERCH, ShellSlotType.TIDEPOOL_EDGE, ShellSlotType.CURRENT_PATH, ShellSlotType.CENTERPIECE), kind = ShellRewardKind.ANIMAL, depthTier = ShellDepthTier.DEEP_OCEAN),
        ShellFindDefinition("creature_leviathan", R.string.shell_find_leviathan_title, R.string.shell_find_leviathan_description, ShellFindCategory.CREATURES, ShellRoomId.FOCUS, "creature_icon_creature_leviathan", "creature_leviathan", true, true, false, setOf(ShellSlotType.CREATURE_PERCH, ShellSlotType.TIDEPOOL_EDGE, ShellSlotType.CURRENT_PATH, ShellSlotType.CENTERPIECE), kind = ShellRewardKind.ANIMAL, depthTier = ShellDepthTier.DEEP_OCEAN),

        ShellFindDefinition(FOCUS_PEBBLE, R.string.shell_find_pebble_title, R.string.shell_find_pebble_description, ShellFindCategory.CORAL, ShellRoomId.FOCUS, "pebble", "pebble", true, true, false, setOf(ShellSlotType.MEMORY_NOOK, ShellSlotType.REEF_SHELF), kind = ShellRewardKind.OBJECT),
        ...
        ShellFindDefinition(FOCUS_LAMP, R.string.shell_object_lamp_title, R.string.shell_object_lamp_description, ShellFindCategory.CORAL, ShellRoomId.FOCUS, "glow_coral", "glow_coral", true, true, false, setOf(ShellSlotType.SHELL_WALL, ShellSlotType.CORAL_BED, ShellSlotType.CENTERPIECE), 80, true, ShellRewardKind.OBJECT),

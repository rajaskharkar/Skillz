...
object SkillzMigrations {
    ...
    val ALL_MIGRATIONS: Array<Migration> = LEGACY_TO_14_MIGRATIONS + MIGRATION_13_14

    fun migrateLegacyDatabaseTo14(db: SupportSQLiteDatabase) {
